...
function zupload()
{
git clone --depth=1 https://github.com/fjrXTR/AnyKernel3.git AnyKernel -b ginkgo
cp out/arch/arm64/boot/Image.gz-dtb AnyKernel
cd AnyKernel
zip -r9 liquid-Shinomiya-kernel-v1.0-ginkgo.zip *
curl -T liquid-Shinomiya-kernel-v1.0-ginkgo.zip temp.sh
}
