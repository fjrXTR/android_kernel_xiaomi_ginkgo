...
function zupload()
{
git clone --depth=1 https://github.com/fjrXTR/AnyKernel3.git -b ginkgo AnyKernel3
cp out/arch/arm64/boot/Image.gz-dtb AnyKernel3 
cd AnyKernel3
zip -r9 liquid-Shinomiya-kernel-v1.0-ginklow.zip *
curl -T liquid-Shinomiya-kernel-v1.0-ginklow.zip temp.sh
}
